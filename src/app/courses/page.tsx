"use client";
import music from "@/data/music_courses.json"
import React from "react";
import { CardBody, CardContainer, CardItem } from "@/components/ui/3d-card";

function page() {
    return (
        <div className="min-h-screen px-20 py-36 bg-black">
            <h1 className="text-white text-center text-4xl md:text-5xl lg:text-7xl mb-5 mt-10 font-bold">All Courses({music.courses.length})</h1>
            <div className="flex flex-wrap justify-center">
                {music.courses.map((course) => (
